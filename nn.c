...
#define LearningRate 0.30     // most books suggest 0.3 as a starting point
#define Momentum     0.72    // must be >=0 and <1
...
#define NumNodes3    15       // output layer is last non-zero layer, and must equal NumOUTs
...
#define Activation3    4     // 1=sig, 2=tanh, 3=relu, 4=leakyRelu, 5=linear
...
#define NumOfRows    15      // largest layer - i.e., max number of rows in the network
