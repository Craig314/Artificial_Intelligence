/**************************************************
  ...
  Modifications by S. Gordon and Craig Hulsebus
  --------------------------------------------------
  Version 5.0 - July 2017
    scaling removed, activation functions added
  --------------------------------------------------
  compile with g++ NNwBP.c
****************************************************/
...
#define Momentum     0.90    // must be >=0 and <1
...
#define NumNodes3    10      // col 5 - hidden layer 3, etc.          
#define NumNodes4    3      // col 4 - hidden layer 2, etc.   
#define NumNodes5    0      // col 3 - output layer is last non-zero layer, and must equal NumOUTs   
#define NumNodes6    0
...
#define Activation3    3     // 1=sig, 2=tanh, 3=relu, 4=leakyRelu, 5=linear
...
// data files -----------------------------------------------
#define TrainFile    "TrainingData.dat"  // file containing training data
#define TestFile     "TestingData.dat"   // file containing testing data 
